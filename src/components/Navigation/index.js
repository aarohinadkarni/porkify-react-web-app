          ...
          <div className="lg:hidden flex justify-between align-middle">
            ...
            <Popover className="mr-2 justify-center items-center flex">
              {({ open }) => (
                <>
                  <Popover.Button
                    className="relative z-10 -m-2 inline-flex items-center rounded-lg stroke-green p-2 hover:bg-gray-200/50 hover:stroke-green active:stroke-green ui-not-focus-visible:outline-none"
